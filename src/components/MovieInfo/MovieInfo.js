        ...
        <div className="infoContent">
            ...
            <div className="mainContentInfo">
                    <div className="posterDetails">
                        ...
                        <span className="year-info">{movieInfo.release_date ? movieInfo.release_date.slice(0,4) : movieInfo.first_air_date ? movieInfo.first_air_date.slice(0,4) : ""}</span>
                        <div>
                          <span style={{color:"#ff6347"}}>Genres</span>  
                          <div className="link-genres">{movieInfo.genres && movieInfo.genres.map((item) => (<span><Link>{item.name}</Link></span>))}</div>
                        </div>
                    </div>
                    ...
                    <div className="details">
                        <div>
                            ...
                            <Slider {...settings}>
                                {cast && cast.map((item,key) => (<div className="castCircle" key={key} ><img key={key} src={item.profile_path ? `https://image.tmdb.org/t/p/w200${item.profile_path}` : person} alt="img"/></div>))}
                            </Slider>
                        </div>
                        ...
                        <div className="trailer">
                            <span className="trailerText">Trailer</span>
